= GeoPackage Extension for Deterministic Grouping and Indexing of Tiles Hierarchies
...
:external-id: https://www.opengis.net/is/geopackage-gi/1.0
:comment: ### Author one
...
include::sections/06-grouping-and-indexing.adoc[]
