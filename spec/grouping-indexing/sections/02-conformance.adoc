...
In order to conform to this candidate OGC standard, a software implementation producing a compliant data product shall implement the core requirement classes defined in this extension.
