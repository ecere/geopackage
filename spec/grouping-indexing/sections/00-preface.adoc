...
This extension was developed and validated during several initiatives, such as the CDB X Code Sprint.
...
////
[THIS TEXT IS ALREADY ADDED AUTOMATICALLY IN THE FRONTPIECE OF ALL OGC DOCUMENTS]
