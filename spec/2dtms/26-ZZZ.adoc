= GeoPackage Extension for 2D Tile Matrix Sets
...
:external-id: https://www.opengis.net/is/geopackage-2dtms/1.0
:comment: ### Author one
...
:keywords: ogcdoc, OGC document, GeoPackage, Tiles, 2DTMS, Tile Matrix Set
:comment: ### Semicolon-delimited list of the submitting organizations; mandatory
:submitting-organizations: US Army Geospatial Center (AGC); Ecere Corporation; Compusult Limited; Image Matters, LLC.
...
include::sections/06-2dtms.adoc[]
