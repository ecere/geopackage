...
:external-id: http://www.opengis.net/IS/GPKG-Styling/1.0
:comment: ### Author one
...
:keywords: ogcdoc, OGC document, GeoPackage, Styling, Portrayal, Symbology, SLD, SE, CartoSym
:comment: ### Semicolon-delimited list of the submitting organizations; mandatory
:submitting-organizations: US Army Geospatial Center (AGC); Ecere Corporation; Compusult Limited; TechMaven Geospatial
...
// include::sections/unsued-conventions.adoc[]

include::sections/05-overview.adoc[]

include::sections/06-styling.adoc[]
