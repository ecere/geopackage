...
====
[%metadata]
identifier:: /req/geopackage-styling/styles
...
====
[%metadata]
identifier:: /req/geopackage-styling/style-sheets
...
====
[%metadata]
identifier:: /req/geopackage-styling/symbols
...
====
[%metadata]
identifier:: /rec/geopackage-styling/symbol-uris
...
====
[%metadata]
identifier:: /req/geopackage-styling/symbol-images
description:: For defining symbols
...
====
[%metadata]
identifier:: /req/geopackage-styling/symbol-content
description:: For defining symbols
...
====
[%metadata]
identifier:: /req/geopackage-styling/fonts
...
====
[%metadata]
identifier:: /req/geopackage-styling/mapboxgl-style
...
part:: The MapboxGL style sheet SHALL refer to a particular tileset by setting the `url` field of a `source` to the GeoDataClass of that tileset, as associated using a `GeoDataClass` type of semantic annotations (`/req/geopackage-styling/semantic-annotations`).
====
...
any data source conforming to the same schemas associated with the GeoDataClass.
