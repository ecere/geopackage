...
[[rc_semantic_annotations]]
[requirements_class]
====
[%metadata]
label:: https://www.opengis.net/geopackage-semantic/req
subject:: Data Product
inherit:: http://www.geopackage.org/spec140/#extension_mechanism
====
...
====
[%metadata]
identifier:: /req/geopackage-semantic/semantic-annotations
...
NOTE: Semantic annotations can be used for the association of both tilesets and styles to a `GeoDataClass` `type` of semantic annotation.

[requirement]
====
[%metadata]
identifier:: /req/geopackage-semantic/sa-reference
