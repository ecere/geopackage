= GeoPackage Extension for 3D Models
...
:external-id: https://www.opengis.net/is/geopackage-3d-models/1.0
:comment: ### Author one
...
:keywords: ogcdoc, OGC document, GeoPackage, 3D Models, glTF, OpenFlight
...
include::sections/06-3D-models.adoc[]
