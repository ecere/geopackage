...
This Standard describes an extension for 3D Models in GeoPackage.
This extension was developed and validated during CDB Code Sprint initiatives.
...
|Ryan Franz (editor)                | Flight Safety International
|===
